                            ...
                            <?php while ($row = $tiketResult->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="proses/proses_hapus_tiket.php?tiketID=<?php echo $row['tiketID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus tiket ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
