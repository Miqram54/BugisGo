...
<div class="wrapper">
       ...
       <div class="sidebar" data-color="blue" data-image="images/bugisgo.jpg">
        ...
        <div class="main-panel">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            <li>
                                <a href="#">
                                    ...
                                    $jam = date("H:i:s");
                                    echo "| <b>" . $jam . " | DASHBOARD PENGELOLA" . "</b>";
                                    ?>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="content">
                <div class="container-fluid">
                    <h1 class="mb-4">Dashboard Pengelola</h1>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <p class="copyright pull-left">
                        &copy; <script>document.write(new Date().getFullYear())</script> BugisGo, Pengelola Dashboard
                    </p>
                </div>
            </footer>
