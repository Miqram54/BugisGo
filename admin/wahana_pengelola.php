       ...
       <div class="sidebar" data-color="blue" data-image="images/bugisgo.jpg">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <a href="tambah_wahana_pengelola.php" class="btn btn-success mb-3">Tambah Wahana</a>
                        ...
                        if ($wahanaResult->num_rows > 0) {
                            while ($row = $wahanaResult->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_wahana_pengelola.php?wahanaID=<?php echo $row['wahanaID']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="wahana_pengelola.php?delete=<?php echo $row['wahanaID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus wahana ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php }
                        } else {
