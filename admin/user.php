...
// Query untuk mendapatkan data pengguna dari tabel 'users'
$penggunaQuery = "SELECT * FROM users";
$penggunaResult = $conn->query($penggunaQuery);
?>
    ...
    <div class="wrapper">
     ...
     <div class="sidebar" data-color="blue" data-image="images/bugisgo.jpg">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <h1 class="mb-4">Pengelolaan Pengguna</h1>

                    <!-- Button to go to form to add a new user -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $no = 1; while ($row = $penggunaResult->fetch_assoc()) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td>
                                        <a href="edit_pengguna.php?userID=<?php echo $row['userID']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="proses/proses_hapus_pengguna.php?userID=<?php echo $row['userID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
