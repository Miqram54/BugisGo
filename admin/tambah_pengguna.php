...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($query) === TRUE) {
        ...
        header("Location: pengguna.php"); // Redirect to the user management page
    } else {
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <h1 class="mb-4">Form Tambah Pengguna</h1>

                <!-- Form Tambah Pengguna -->
                <form action="proses/proses_tambah_pengguna.php" method="POST">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="title">Form Pengguna Baru</h4>
                        </div>
                        <div class="card-body">
